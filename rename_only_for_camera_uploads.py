    ...
    try :
        ...
        if is_image :
            try :
                ...
                new_file_name = time.strftime("%Y-%m-%d %H.%M.%S", time.localtime(os.path.getmtime(old_file_path)))
                print(time.strftime("%Y-%m-%d %H.%M.%S", time.localtime(os.path.getmtime(old_file_path))))
        else : # Video
            # Reformat the date taken to "YYYY-MM-DD HH-mm-ss"
            print ("______________________________________")
            new_file_name = time.strftime("%Y-%m-%d %H.%M.%S", time.localtime(os.path.getmtime(old_file_path)))
            print ("Open video :",time.strftime("%Y-%m-%d %H.%M.%S", time.localtime(os.path.getmtime(old_file_path))))
